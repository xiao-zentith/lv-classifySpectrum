...
from trainDemo import pytorchPlot
...
# 类别名称和标签映射
categories = {
    'ce6_0': 0,  'ce6_5': 0, 'ce6_10': 0, 'ce6_20': 0, 'ce6_2-5': 0,
    'hpts_0': 1,  'hpts_5': 1, 'hpts_10': 1, 'hpts_20': 1, 'hpts_2-5': 1,
    'Ru_0': 2, 'Ru_5': 2, 'Ru_10': 2, 'Ru_20': 2, 'Ru_2-5': 2,
    'C6_0': 3, 'C6_10': 3, 'C6_20': 3, 'C6_5': 3, 'C6_2-5': 3,
    'F_0': 4, 'F_10': 4, 'F_20': 4, 'F_5': 4, 'F_2-5': 4
}
# 读取数据并分配标签
all_data = []
...
# 添加噪声
noise_normal = np.random.normal(0, 0.15, (481, 301))  # 正态分布噪声
noise_uniform = np.random.uniform(-0.1, 0.1, (481, 301))  # 均匀分布噪声
...
history = model.fit(X_train, y_train, epochs=40, batch_size=32, validation_data=(X_val, y_val), callbacks=[checkpoint, early_stop])
...
# pytorchPlot.roccurve_mulitiply(y_test_bin, logits)
