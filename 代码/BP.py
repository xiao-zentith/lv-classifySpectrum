...
history = model.fit(X_train, y_train, epochs=100, batch_size=32, validation_data=(X_val, y_val), callbacks=[checkpoint, early_stop])
...
plot.roccurve_mulitiply(y_test_bin, probablities)